...
\begin{itemize}
	...
	\item Menghasilkan \textit{Clean URLs} \\
		\textit{URL} yang dihasilkan oleh \textit{CodeIgniter} \textit{Clean URLs} dan \textit{search-engine friendly}. Clean URLs akan mempermudah pengguna dalam membaca URL. Contoh perbandingan URL biasa dengan Clean URLs: URL biasa: \path{\\example.com\index.php?page=news}, Clean URLs: \path{\\example.com\news}.
