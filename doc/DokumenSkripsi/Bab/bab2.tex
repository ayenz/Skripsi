...
Listing \ref{ls:1} menunjukan isi \textit{file} \textit{.htaccess2}: 
\begin{lstlisting}[basicstyle=\ttfamily, caption=Isi \textit{file} \textit{.htaccess2}, label=ls:1, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
\begin{itemize}
	...
	Listing \ref{ls:2} menunjukan solusi menggunakan bahasa \textit{C}
	\begin{lstlisting}[basicstyle=\ttfamily, caption=Solusi Menggunakan Bahasa \textit{C}, label=ls:2, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
#include<stdio.h>
int main(){
	int n;
...
\end{lstlisting} 
	...
	Listing \ref{ls:3} menunjukan solusi menggunakan bahasa \textit{C++}
	\begin{lstlisting}[basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, caption=Solusi Menggunakan Bahasa \textit{C++}, label=ls:3, breaklines=true]
#include <iostream>
using namespace std;
int main(){
	int n, sum=0;
...
\end{lstlisting} 
	...
	Listing \ref{ls:4} menunjukan solusi menggunakan bahasa \textit{Java}
	\begin{lstlisting}[basicstyle=\ttfamily, caption=Solusi Menggunakan Bahasa \textit{Java}, label=ls:4, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
\end{lstlisting}
	...
	Listing \ref{ls:5} menunjukan solusi menggunakan bahasa \textit{C}
	\begin{lstlisting}[basicstyle=\ttfamily, caption=Solusi Menggunakan Bahasa \textit{C}, label=ls:5, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
#include<stdio.h>
int main(){
	int n , m1=0, m2=0;
...
\end{lstlisting}
	...
	Listing \ref{ls:6} menunjukan solusi menggunakan bahasa \textit{C++}
	\begin{lstlisting}[basicstyle=\ttfamily, caption=Solusi Menggunakan Bahasa \textit{C++}, label=ls:6, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
#include<iostream>
using namespace std;
int main(){
