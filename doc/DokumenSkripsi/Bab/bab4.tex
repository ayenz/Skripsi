...
\begin{figure}[H]
	\centering  
	\includegraphics[width=0.5\textwidth]{/implementasi/txt}  
...
\begin{figure}[H]
	\centering  
	\includegraphics[width=0.3\textwidth]{/implementasi/logs}  
...
\begin{figure}[H]
	\centering  
	\includegraphics[width=0.3\textwidth]{/implementasi/lock}  
...
\begin{figure}[H]
	\centering  
	\includegraphics[width=0.5\textwidth]{/implementasi/arch}  
...
\begin{figure}[H]
	\centering  
	\includegraphics[width=0.5\textwidth]{/implementasi/hof}  
