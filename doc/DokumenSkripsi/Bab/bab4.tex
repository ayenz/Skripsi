...
Selain menambahkan kelas \textit{model, view} dan \textit{controller}, terdapat perubahan dan penambahan kode pada kelas \textit{controller Login.php} dan \textit{config Install.php}. Perubahan dan penambahan kode di \textit{controller Login.php} untuk menyimpan data login pengguna ke dalam database. Berikut perubahan dan penambahan kode di \textit{controller Login.php}\\
\textit{Login.php}
\begin{lstlisting}[language=diff, basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
\end{lstlisting}
~\\
Perubahan dan penambahan kode di \textit{config Install.php} untuk membuat tabel \textit{shj\_logins} pada \textit{database} saat penginstalan \textit{SharIF Judge}. Berikut perubahan dan penambahan kode di \textit{config Install.php}\\
\textit{Install.php}
\begin{lstlisting}[language=diff, basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
Dari rancangan algoritma yang diterapkan, terdapat penambahan kode pada beberapa kelas. Beberapa kelas tersebut antara lain \textit{controller Profile.php, controller Settings.php, model User\_model.php, view settings.twig}, \textit{view profile.twig} dan \textit{config Install.php}.
~\\
Perubahan dan penambahan kode di \textit{Profile.php} untuk mengirimkan nilai '\textit{lock\_student\_display\_name}' ke halaman \textit{profile.twig}. Berikut hasil perubahan dan penambahan kode program yang dilakukan di \textit{Profile.php}\\
\textit{Profile.php}
\begin{lstlisting}[language=diff, basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
\end{lstlisting}
~\\
Perubahan dan penambahan kode di \textit{config Install.php} untuk menambahkan atribut \linebreak \textit{lock\_student\_display\_name} pada tabel \textit{shj\_settings} di \textit{database} saat penginstalan \textit{SharIF Judge}. Berikut perubahan dan penambahan kode di \textit{config Install.php}\\
\textit{Install.php}
\begin{lstlisting}[language=diff, basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
Dari rancangan algoritma yang diterapkan, terdapat penambahan kode pada beberapa kelas. Beberapa kelas tersebut antara lain \textit{model Assignment\_model.php, view add\_assignment.twig}, \textit{view dashboard.twig} dan \textit{config Install.php}.
~\\
...
\end{lstlisting}
~\\
Perubahan dan penambahan kode di \textit{config Install.php} untuk menambahkan atribut \linebreak \textit{archived\_assignment} pada tabel \textit{shj\_assignments} di \textit{database} saat penginstalan \textit{SharIF Judge}. Berikut perubahan dan penambahan kode di \textit{config Install.php}\\
\textit{Install.php}
\begin{lstlisting}[language=diff, basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
...
~\\
Perubahan dan penambahan kode di model \textit{User\_model} untuk memanggil \textit{library Dapphp/Radius} dan mengintegrasikan \textit{login} pengguna \textit{Sharif Judge} ke \textit{server RADIUS}. Berikut hasil penambahan kode program yang dilakukan di model \textit{User\_model}\\
\textit{User\_model.php}
\begin{lstlisting}[language=diff, basicstyle=\ttfamily, frame=single,
columns=fullflexible, keepspaces=true, breaklines=true]
@@ -5,6 +5,7 @@
