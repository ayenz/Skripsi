...
\judulENG{Customization of Sharif Judge for The Requirement Department of Informatics}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
Sharif Judge was lastly committed in GitHub at July 2015 and leaving some bugs.	Beside leaving some bugs, Department of Informatics have the requirements that are more specific. In this case Sharif Judge doesn't quite fulfill the requirement of Department of Informatics. The development of Sharif Judge software needs to be done in order to solve all those problems.
	
Customization of Sharif Judge has an objective to make Sharif Judge can fulfill the requirement of Department of Informatics again. From all those requirements, many features is designed to be implemented into Sharif Judge software. By implementing new features, it is expected that Sharif Judge software can re-fulfill the requirement of Department of Informatics.
} 
%=============================================================================
...
\kunciENG{Customization, development, requirements, features, Sharif Judge, Department of Informatics}
%=============================================================================
