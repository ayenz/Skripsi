...
%=============================================================================
\namanpm{Stillmen Vallian}{2014730083}
\tanggal{23}{5}{2018}
\pembimbing{\LCA}{}    
\penguji{\HUH}{<<penguji 2>>} 
%=============================================================================
...
%=============================================================================
\judulINA{Kustomisasi Sharif Judge untuk Kebutuhan Program Studi Teknik Informatika}
\judulENG{Customization of Sharif Judge for Needs of Informatics Department}
% Sharif Judge Customization for Department of Informatics' Requirements
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
%=============================================================================
\abstrakINA{
\textit{Sharif Judge} adalah \textit{online judge} gratis untuk bahasa pemrograman C, C++, Java dan Python. \textit{Sharif Judge} diciptakan oleh Mohammad Javad Naderi pada tahun 2014. \textit{Sharif Judge} dibangun menggunakan\textit{ framework CodeIgniter} dan bersifat \textit{open source}. Pada perangkat lunak \textit{Sharif Judge}, terdapat banyak fitur yang dapat digunakan. Fitur-fitur tersebut seperti deteksi kecurangan (kode yang mirip), mengunduh nilai peserta dalam bentuk \textit{excel}, mengunduh kode jawaban peserta dalam bentuk \textit{zip}, menampilkan nilai seluruh peserta dan lain sebagainya. \textit{Sharif Judge} digunakan oleh banyak kalangan, salah satunya adalah Program Studi Teknik Informatika Universitas Katolik Parahyangan.

Perangkat lunak \textit{Sharif Judge} digunakan oleh Program Studi Teknik Informatika Universitas Katolik Parahyangan pada mata kuliah seperti Algoritma dan Struktur Data serta Desain dan Analisis Algoritma. Perangkat lunak ini sangat membantu para dosen dan mahasiswa. Sistem penilaian otomatis merupakan salah satu fitur yang sering digunakan oleh para dosen. Dengan memanfaatkan fitur di atas, dosen dapat dengan mudah memberikan nilai tugas, kuis dan ujian.

\textit{Sharif Judge} terakhir dicommit di \textit{GitHub} pada bulan Juli 2015 dan meninggalkan beberapa \textit{bug}. Selain meninggalkan beberapa \textit{bug}, Program Studi Teknik Informatika memiliki kebutuhan-kebutuhan yang lebih spesifik. Hal ini menyebabkan \textit{Sharif Judge} kurang memenuhi kebutuhan Program Studi Teknik Informatika. Pengembangan perangkat lunak Sharif Judge perlu dilakukan untuk mengatasi masalah-masalah di atas.

Kustomisasi \textit{Sharif Judge} memiliki tujuan agar \textit{Sharif Judge} dapat kembali memenuhi kebutuhan Program Studi Teknik Informatika. Dari kebutuhan-kebutuhan tersebut, dirancang fitur-fitur untuk diimplementasi ke dalam perangkat lunak Sharif Judge. Dengan mengimplementasikan fitur-fitur baru, diharapkan perangkat lunak \textit{Sharif Judge} dapat kembali memenuhi kebutuhan Program Studi Teknik Informatika.
}

\abstrakENG{Sharif Judge is a free online judge for C, C++, Java and Python programming courses. \textit{Sharif Judge} was created by Mohammad Javad Naderi in 2014. Sharif Judge was built by CodeIgniter Framework and has an open source characteristic. At Sharif Judge software, there are many features that can be used. Those features are like cheat detection (resemble codes), downloading participant's score in excel format, downloading participant's answer code in zip format, display the score of all those participants and so many else. Sharif Judge is used by many circles, one of them is Department of Informatics Parahyangan Catholic University.
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{Kustomisasi, pengembangan, kebutuhan, fitur, \textit{Sharif Judge}, Program Studi Teknik Informatika}
\kunciENG{Customization, development, needs, features, Sharif Judge, Informatics Department}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\untuk{Dipersembahkan kepada Sang Tri Ratna, keluarga tercinta, teman-teman yang mendukung, semua orang yang berperan dalam pembuatan skripsi ini dan diri sendiri}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\prakata{Puji Syukur kepada Sang Tri Ratna atas berkat dan perlindungan yang telah diberikan kepada penulis sehingga dapat menyelesaikan skripsi dengan judul Kustomisasi Sharif Judge untuk Kebutuhan Program Studi Teknik Informatika. Penulis juga berterima kasih kepada pihak-pihak yang telah memberikan dukungan serta bantuan kepada penulis dalam menyelesaikan skripsi ini. Penulis ingin mengucapkan terima kasih kepada:
\begin{enumerate}
	\item Kedua orang tua penulis, Bapak Sakiman dan Ibu Lily Leonita yang selalu memberikan dukungan selama pengerjaan skripsi ini.
	\item Kakak dan adik penulis, Stefen Valerian dan Stevie yang selalu memberikan semangat dan motivasi kepada penulis.
	\item Bapak Pascal Alfadian Nugroho selaku dosen pembimbing yang selalu membimbing penulis dalam menyusun skripsi.
	\item Bapak Husnul Hakim dan Bapak Kristopher David Harjono selaku dosen penguji yang telah	memberikan saran dan masukan yang baik untuk memperbaiki penyusunan skripsi ini.
	\item Ibu Joanna Helga, Ibu Luciana Abednego, Ibu Vania Natali dan Bapak Claudio Fransiscus yang telah memberikan masukan untuk perangkat lunak yang dikembangkan pada skripsi ini.
	\item Christian Gunawan, Hereza Ardithia dan Kalas Gusna Kinasah selaku admin Lab FTIS yang telah membantu penulis dalam proses penginstalan dan pengujian perangkat lunak.
	\item Stanley Hanes, Kresna Dwi Cahyo, Ivan, Marchella Metta dan Riki Rusli selaku teman seperjuangan dan bertukar pikiran yang selalu membantu serta memberikan masukan kepada penulis dalam menyusun skripsi.
	\item Daniel Ferdinan, Fedrian Hermana, Kevin Jonathan, Kelvin Tandika dan Andre selaku teman yang selalu memberikan semangat dan dorongan kepada penulis.
	\item Pihak-pihak lain yang telah membantu penulisan skripsi ini, yang terus memberikan doa, perhatian dan semangat kepada penulis.
\end{enumerate}
